...
class DocRef extends grapp_ref_1.GrappRef {
    ...
    get selector() { return this.docTypeRef.selector; }
    _create(candidate) {
    ...
    _watch(query, filter) {
        return Observable_1.Observable.merge(Observable_1.Observable.fromPromise(this._find(query)), this.root.docEvents
            .mergeMap(e => {
    ...
    _watchOne(query, filter) {
        return Observable_1.Observable.merge(Observable_1.Observable.fromPromise(this._findOne(query)), this.root.docEvents
            .mergeMap(e => {
            if (typeof filter !== 'function')
                return Promise.resolve(false);
            let filterResult = filter(e);
