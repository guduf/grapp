...
class DocOpeRef extends type_ref_1.TypeRef {
    constructor(grappRef, target, meta) {
        ...
        this.target = target;
        this.meta = meta;
        const docTarget = this.meta.docTarget();
        this.targetMeta = type_1.getTypeMeta(docTarget);
        if (!(this.targetMeta instanceof doc_1.DocMeta))
            throw Error('Cant get docMeta');
        this.targetFields = fields_1.mapFieldMeta(docTarget);
