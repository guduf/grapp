...
class DocRef extends grapp_ref_1.GrappRef {
    ...
    _watch(query) {
        return Observable_1.Observable.merge(Observable_1.Observable.fromPromise(this._find(query)), this.docEvents.mergeMap(e => this._find(query)));
    }
    _watchOne(query) {
        return Observable_1.Observable.merge(Observable_1.Observable.fromPromise(this._findOne(query)), this.docEvents.mergeMap(e => this._findOne(query)));
    }
    _instanciate(id) {
